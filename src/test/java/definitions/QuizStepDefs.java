...
//        assertThat(getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'"+quizTitle+"')]")).isDisplayed()).isTrue();
    ...
    public void iAddQuestions(int numOfQuestions) {
//        getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'Q1')]/../../..//*[contains(text(),'Textual')]")).click();
//        getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'Q1')]/../../..//*[@formcontrolname='question']")).sendKeys("test");


        for (int x = 1; x <= numOfQuestions; x++) {
            getDriver().findElement(By.xpath("//div/button/span/*[contains(text(),'add_circle')]")).click();


        }
//        String actualNumberOfQuestions = getDriver().findElement(By.xpath("//mat-panel-title[contains(text(),'" + numOfQuestions + "')]")).getText();
//        assertThat(actualNumberOfQuestions.equals("Q" + numOfQuestions + ": new empty question")).isTrue();

    }



    @And("I add {int} questions and confirm total number of questions added")
    public void iAddQuestionsAndConfirmTotalNumberOfQuestionsAdded(int numOfQuestions) {
        for (int x = 1; x <= numOfQuestions; x++) {
            getDriver().findElement(By.xpath("//div/button/span/*[contains(text(),'add_circle')]")).click();
